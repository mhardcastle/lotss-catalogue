...
lofar=hp.read_map('/data/lofar/mjh/temperature_hp.fits')
...
new_map=hp.alm2map(new_alm,nside=4096)
new_map[np.isnan(lofar)]=np.nan

hp.fitsfunc.write_map('/data/lofar/mjh/merged-weights-level-pixweight.fits',new_map,overwrite=True)
