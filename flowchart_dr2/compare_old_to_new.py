...
print ('There are ',len(tsellgz_newsel_notpflgz),' sources selected this time for lgz that were not selected before for either lgz or pf (with lgz outcome)  - select these')
