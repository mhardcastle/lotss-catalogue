...
classifications=(('Symmetry',
                  (('hreflect','Horizontal reflection'),
                   ('vreflect','Vertical reflection'),
                   ('rotation','Rotational (s-shaped jet)'),
                   ('asymm2','Asymmetry: 2 lobes'),
                   ('asymm1','Asymmetry: 1 lobe / head-tail'),
                   ('symmother','Other symmetry'),
                   ('symmunclass','Unable to determine'))),
                 ('Jet Structure',
                  (('fri','FRI'),
                   ('frii','FRII'),
                   ('jetunclass','Unclear'),
                   ('bridged','Bridged jet'),
                   ('discont','Discontinuous jet'),
                   ('misalign','Misaligned jet'),
                   ('curved','Curved jet'),
                   ('split','Split stream'),
                   ('filament','Clear filaments'),
                   ('beamed','Strongly beamed'))),
                  ('Lobe Structure',
                   (('terminal1','Terminal hotspot: single lobe'),
                    ('terminal2','Terminal hotspot: multiple lobes'),
                    ('multiple','Multiple hotspots'),
                    ('ldistinct','Distinct lobe(s)'),
                    ('wings','Wings'),
                    ('plumes','Plumes'),
                    ('tails','Tails'),
                    ('restart','Restarting'),
                    ('shuttlecock','Shuttlecock / pinched / pointed lobe(s)'),
                    ('rounded','Blunted / rounded lobe(s)'),
                    ('other','Any others'))),
                 ('Environment',
                  (('compact','Nearby compact source'),
                   ('ccompact','Cluster of 2+ compact objects'),
                   ('ccomplex','Complex / diffuse cluster'),
                   ('merger','Obvious merger'),
                   ('pmerger','Possible merger'),
                   ('aligned','Nearby source not merging but aligned'))),
                 ('Other',
                  (('spiral','Spiral'),
                   ('fuzz','Fuzz'),
                   ('blend','Blend'),
                   ...
                   ('revisit','Revisit to fix bad association'))))
