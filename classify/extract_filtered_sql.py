...
t=Table.read('LoTSS_DR2_v110.srl_13h.lr-full.sorted_step2_flux4.prefilter_lgz_weave_selection_'+table+'.fits')
...
t.write('LoTSS_DR2_v110.srl_13h.lr-full.sorted_step2_flux4.prefilter_lgz_weave_selection_'+table+'_classified.fits')

tf=t[t['Prefilter']==1]
tf.write('LoTSS_DR2_v110.srl_13h.lr-full.sorted_step2_flux4.prefilter_lgz_weave_selection_'+table+'_tolgz.fits')
