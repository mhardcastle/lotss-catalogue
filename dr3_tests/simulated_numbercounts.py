...
ti=Table.read('../combined_catalog.fits')
ti['pixel']=hp.ang2pix(NSIDE,ti['source_ra'],ti['source_dec'],lonlat=True)
ti['source_144mhz_corrupt_fullcor'].name='Total_flux'
ti=ti[~np.isnan(ti['Total_flux'])]
#ti['source_flux_144mhz'].name='Total_flux'
