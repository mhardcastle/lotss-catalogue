...
if __name__=='__main__':
    ...
    for i,r in enumerate(t):
        ...
        if r['OptID_Name']=="None":
            ...
            selected=[int(row['Opt_id']) for row in mts]
        else:
            selected=[int(r['OptID_Name'])]
        ...
        while not(stop):
            ...
            f=show_overlay(lhdu,ohdu,ra,dec,size,coords_color='red',coords_ra=r['RA'],coords_dec=r['Dec'],coords_lw=3,lw=2,no_labels=True,title=title,block=False,interactive=False,drlimit=8000,peak=peak,plotpos=[(pwg,'+'),(mlt,'h','red'),(gzgals,'D','magenta')])
