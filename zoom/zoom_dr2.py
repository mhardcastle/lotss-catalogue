...
if __name__=='__main__':
    ...
    mode='wise'
    for sourcenumber,sourcename in enumerate(sourcelist):
        if 'Deleted' in s.sd[sourcename]: continue
